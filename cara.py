...
while True: # main game loop
    ...
    if i%2== 0 or i%3==0 or i%5==0 or i%7==0 or i%11==0 or i%13==0:
        ...
        pygame.draw.line(pantalla, BLACK, (155, 160),(160,165),2)
        pygame.draw.line(pantalla, BLACK, (155, 160), (160, 155),2)
        pygame.draw.line(pantalla, BLACK, (130, 160),(125,165),2)
        pygame.draw.line(pantalla, BLACK, (130, 160), (125, 155),2)
    i += 1
    print(i)
